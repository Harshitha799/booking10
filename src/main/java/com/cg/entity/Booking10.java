...
public class Booking10 {
	...
	public Passenger10 getPassengerInfo() {
		return passengerInfo;
	}

	public void setPassengerInfo(Passenger10 passengerInfo) {
	...
	public void setUserInfo(User10 userInfo) {
	...
	public Booking10(long bookingId,
			...
			Passenger10 passengerInfo, User10 userInfo) {
		super();
		this.bookingId = bookingId;
		this.username = username;
		this.busNumber = busNumber;
