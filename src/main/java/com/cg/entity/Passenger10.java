...
public class Passenger10 
{
	...
	public Passenger10(int passengerId, @NotEmpty(message = "username should not be empty") String username,
			String firstName, String lastName, long phoneNumber, @Email(message = "Enter valid email id") String email,
			long identityDocNumber, String identityDocumentName, List<Booking10> booking) {
		super();
		this.passengerId = passengerId;
		this.username = username;
		this.firstName = firstName;
