...
public interface IFeedBackRepository extends JpaRepository<Feedback10, Integer>
{
	...
	//public List<Feedback11> findByRouteName(String routeName);
	
	@Query("select fb from Feedback10 fb "
			+ "where fb.busoperator1=:busoperator")
	public List<Feedback10> findByBusOperator(@Param("busoperator") BusOperatorDto busoperator);
