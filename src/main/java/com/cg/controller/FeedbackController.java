...
//	public List<Feedback11> viewAllFeedBacks(@Valid @PathVariable String routeName){
//		try {
//			List<Feedback11> feedbackbyroutename = feedbackservice.viewAllFeedBacks(routeName);
...
//	}
	...
	@GetMapping(value="/viewallfeedbackbybusoperator")
	public List<Feedback10> viewAllFeedBacks(@Valid @RequestBody BusOperatorDto busoperator){
		try {
