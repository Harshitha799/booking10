...
public class BookingController {
	...
	public ResponseEntity<Object> addBooking(@Valid @RequestBody BookingDto bookingdto, BindingResult bindingResult) {
		...
		if (bindingResult.hasErrors()) {
			...
			throw new OnlineBusBookingValidationException(errorList);
		}
		try {
	...
	public ResponseEntity<Object> updateBookingById(@Valid @PathVariable long bookingId, @RequestBody BookingDto bookingdto, BindingResult bindingResult) {
		...
		try {
			bookingService.updateBookingById(bookingId, bookingdto);
		} 
		catch (IdNotFoundException e) {
